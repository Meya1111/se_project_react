...
function Profile({ username, avatar, clothingItems, onCardClick, onAddClick, weatherData }) {
  ...
  currentTemperatureUnit === "F"
    ...
    <div className="cards__text">
     <p>
     Today is {typeof displayTemp === "number" ? displayTemp : Math.round(weatherData?.temp?.f ?? 0)}°
